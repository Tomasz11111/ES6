		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'label',
						{ htmlFor: 'searchText', style: { fontSize: '20px', display: 'block', textAlign: 'center' } },
						'Search by user name'
					),
...
var User = function (_React$Component3) {
	...
	_createClass(User, [{
		...
		value: function render() {
			return React.createElement(
				'div',
				{ style: { display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', paddingRight: '20px' } },
				React.createElement('img', { src: this.props.user.avatar_url, style: { maxWidth: '200px', display: 'block', paddingTop: '50px' } }),
				React.createElement(
					'a',
					{ href: this.props.user.html_url, target: '_blank', style: { display: 'inlineBlock', paddingTop: '20px', fontSize: '20px' } },
